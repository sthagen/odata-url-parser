...
const AppName = "odata-url-parser"
...
func (app *appEnv) ParseArgs(args []string) error {
	...
	fl.Usage = func() {
		fmt.Fprintf(fl.Output(), `odata-url-parser - a Go CLI application template cat clone

Usage:

	odata-url-parser [options]
...
`)
	...
	if err := ff.Parse(fl, args, ff.WithEnvVarPrefix("ODATA_URL_PARSER")); err != nil {
		return err
	}
	return nil
}
